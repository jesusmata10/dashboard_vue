...
const props = defineProps({
  ...
  parentesco: { type: Object, default: () => { } },
...
const openModal = (op, name, email, usuarios, roles, estados) => {
  modal.value = true;
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" class="px-6 py-3">Acci&oacuten</th>
            </tr>
            </thead>
            <tbody>
            ...
            <div class="mx-auto mt-16 max-w-xl sm:mt-20">
              <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3">
                ...
                <div>
                  ...
                  <div class="mt-1">
                    <TextInput id="fecha" v-model="form.fecha" type="date" class="mt-1"></TextInput>
                ...
                <div>
                  ...
                  <SelectInput id="parentesco_id" :options="parentesco" v-model="form.parentesco_id"
                    class="mt-1 block w-3/4" placeholder="Parentesco">
                  </SelectInput>
                ...
                <div class="">
                  ...
                  <select v-model="form.estados_id"
                    ...
                    id="estados_id" :value="modelValue" @change="$emit('update:modelValue', $event.target.value)"
                    ref="input">
                    <option disabled value="">Selecione una opcion</option>
                    <option v-for="op in estados" :key="op.id" :value="op.id">
                      {{ op.estado }}
                    </option>
                  </select>
                  <!--<SelectInput id="estados_id" :options="estados" v-model="form.estados_id" 
              ...
              <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3">
                <div>
                  ...
                  <TextInput id="name" v-model="form.name" type="text" class="mt-1" placeholder="Name">
                  </TextInput>
                  <InputError :message="form.errors.nacionalidad" class="mt-2"></InputError>
                </div>
                ...
                <div>
                  ...
                  <TextInput id="password" v-model="form.password" type="" class="mt-1" placeholder="Password">
                  </TextInput>
                ...
                <div>
                  ...
                  <TextInput id="password_confirmation" v-model="form.password_confirmation" type="" class="mt-1"
                    placeholder="Confirmar Password"></TextInput>
                  <InputError :message="form.errors.password_confirmation" class="mt-2"></InputError>
                </div>
                <div>
                  <InputLabel for="rol" value="Rol"></InputLabel>
                  <SelectInput id="rol" :options="roles" v-model="form.rol" class="mt-1 block w-3/4" placeholder="Rol">
                  </SelectInput>
                </div>
              </div>
              <div class="mt-10">
